...
- source_sentence: Can students with significant full-time work experience waive the
  ...
  sentences:
  - '• Career Seminar (Required) Pass/Fail The Career Seminar (Pass/Fail) supports
    the development of industry professional skills, job and/or internship searches,
    and other in-demand areas of competency among today’s employers. Students enroll
    ...
    • Machine Learning II Letter Grade The objective of this course is three-folds–first,
    ...
    • Elective 2 Letter Grade Elective offerings vary. Students will work with their
    ...
    • Data Science Capstone Project Letter Grade The required Capstone Project is
  ...
  - The Pass/Fail Career Seminar supports the development of industry professional
    ...
    among today’s employers. Students enroll in the Career Seminar each quarter in
  ...
  - 'Course: Unknown Course
    ...
    • Elective 4 Letter Grade Elective offerings vary. Students will work with their
    academic advisor to select electives based on their interests and course availability.
    Past electives include: Generative AI Principles, Advanced Computer Vision with
    Deep Learning, Advanced Machine Learning and Artificial Intelligence, Bayesian
    Machine Learning with GenAI Applications, Data Science for Algorithmic Marketing,
...
- source_sentence: What elective courses are available in the University of Chicago's
    ...
    experience option?
  sentences:
  - Greg’s industry roles include Chief Analytics Officer at Harland Clarke Holdings,
    Director at Google, EVP/Managing Director at Publicis Groupe, and Analytics Practice
    Lead at PwC. Greg’s patented cloud-based media analytics platform was highlighted
...
- source_sentence: What specific software packages will be covered in the Data Engineering
  ...
  sentences:
  - UChicago’s Master’s in Applied Data Science program recruits industry leaders
  ...
  - 'Course: Unknown Course
    ...
    Description: Data Engineering Platforms teaches effective data engineering—an
    ...
    • Data Engineering Platforms for Analytics or Big Data and Cloud Computing Letter
    Grade Data Engineering Platforms teaches effective data engineering—an essential
...
- name: all-MiniLM-L6-v2-uchicago-msads-matryoshka_v2
  ...
  - task:
    ...
    - type: cosine_ndcg@10
      value: 0.4372214787178998
      name: Cosine Ndcg@10
    - type: cosine_mrr@10
      value: 0.38551373954599766
      name: Cosine Mrr@10
    - type: cosine_map@100
      value: 0.40424068225199244
      name: Cosine Map@100
  - task:
      type: information-retrieval
      name: Information Retrieval
    ...
    - type: cosine_precision@1
      ...
      name: Cosine Precision@1
    - type: cosine_precision@3
      value: 0.15053763440860218
      name: Cosine Precision@3
    - type: cosine_precision@5
      value: 0.10537634408602148
      name: Cosine Precision@5
    - type: cosine_precision@10
      value: 0.06236559139784944
      name: Cosine Precision@10
    - type: cosine_recall@1
      value: 0.27956989247311825
      name: Cosine Recall@1
    ...
    - type: cosine_recall@10
      ...
      name: Cosine Recall@10
    - type: cosine_ndcg@10
      value: 0.43985436305872844
      name: Cosine Ndcg@10
    - type: cosine_mrr@10
      value: 0.38207885304659495
      name: Cosine Mrr@10
    - type: cosine_map@100
      value: 0.3988150827239457
      name: Cosine Map@100
  - task:
      type: information-retrieval
      name: Information Retrieval
    ...
    - type: cosine_recall@10
      ...
      name: Cosine Recall@10
    - type: cosine_ndcg@10
      value: 0.4117656874309288
      name: Cosine Ndcg@10
    - type: cosine_mrr@10
      value: 0.3572580645161291
      name: Cosine Mrr@10
    - type: cosine_map@100
      value: 0.37672228508311306
      name: Cosine Map@100
  - task:
      type: information-retrieval
      name: Information Retrieval
    ...
    - type: cosine_precision@1
      ...
      name: Cosine Precision@1
    - type: cosine_precision@3
      value: 0.13261648745519714
      name: Cosine Precision@3
    - type: cosine_precision@5
      value: 0.09892473118279567
      name: Cosine Precision@5
    - type: cosine_precision@10
      value: 0.06129032258064514
      name: Cosine Precision@10
    - type: cosine_recall@1
      value: 0.26881720430107525
      name: Cosine Recall@1
    ...
    - type: cosine_recall@10
      ...
      name: Cosine Recall@10
    - type: cosine_ndcg@10
      value: 0.42055793221931215
      name: Cosine Ndcg@10
    - type: cosine_mrr@10
      value: 0.361136712749616
      name: Cosine Mrr@10
    - type: cosine_map@100
      value: 0.3753991392882838
      name: Cosine Map@100
---
...
print(similarities)
# tensor([[1.0000, 0.7250, 0.1380],
#         [0.7250, 1.0000, 0.2037],
#         [0.1380, 0.2037, 1.0000]])
```
...
| cosine_recall@10    | 0.6022     |
| **cosine_ndcg@10**  | **0.4372** |
| cosine_mrr@10       | 0.3855     |
...
| Metric              | Value      |
|:--------------------|:-----------|
| cosine_accuracy@1   | 0.2796     |
| cosine_accuracy@3   | 0.4516     |
| cosine_accuracy@5   | 0.5269     |
| cosine_accuracy@10  | 0.6237     |
| cosine_precision@1  | 0.2796     |
| cosine_precision@3  | 0.1505     |
| cosine_precision@5  | 0.1054     |
| cosine_precision@10 | 0.0624     |
| cosine_recall@1     | 0.2796     |
| cosine_recall@3     | 0.4516     |
| cosine_recall@5     | 0.5269     |
| cosine_recall@10    | 0.6237     |
| **cosine_ndcg@10**  | **0.4399** |
| cosine_mrr@10       | 0.3821     |
| cosine_map@100      | 0.3988     |
...
| Metric              | Value      |
|:--------------------|:-----------|
| cosine_accuracy@1   | 0.2473     |
| cosine_accuracy@3   | 0.4301     |
| cosine_accuracy@5   | 0.5269     |
| cosine_accuracy@10  | 0.5806     |
| cosine_precision@1  | 0.2473     |
| cosine_precision@3  | 0.1434     |
| cosine_precision@5  | 0.1054     |
| cosine_precision@10 | 0.0581     |
| cosine_recall@1     | 0.2473     |
| cosine_recall@3     | 0.4301     |
| cosine_recall@5     | 0.5269     |
| cosine_recall@10    | 0.5806     |
| **cosine_ndcg@10**  | **0.4118** |
| cosine_mrr@10       | 0.3573     |
| cosine_map@100      | 0.3767     |
...
| 4.8077 | 125  | 0.3656        | -                      | -                      | -                      | -                     |
| 5.0    | 130  | -             | 0.4372                 | 0.4399                 | 0.4118                 | 0.4206                |
